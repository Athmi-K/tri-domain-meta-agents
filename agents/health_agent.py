...
def run(request) -> dict:
    ...
    if detected_domain != "health": domain_label = { "career": "Career", "finance": "Finance", }.get(detected_domain, "the appropriate") 
    return { "domain": "health", "tools_used": [], "recommendation": ( "This question does not belong to the Health domain. " f"Please switch to the {domain_label} domain." ), "reason": f"Detected domain: {detected_domain}", "confidence": 1.0, "confidence_level": "High", }
